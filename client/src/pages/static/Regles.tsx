    ...
    <div className="container_rules">
      ...
      <div className="instructions">
        <p id="intro_rules">
          ...
          rues comme un·e historien·ne moderne, redécouvrant les trésors cachés
          de nos villes. Des récompenses pour les contributeur·rices assidu·es,
          avec un classement officiel.
        </p>
      </div>
