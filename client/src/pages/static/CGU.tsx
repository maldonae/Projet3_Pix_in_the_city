  ...
  return (
    <div className="cgu_text">
      ...
      <p>
        ...
        site. Street_art se réserve le droit de modifier unilatéralement et à
      ...
      <br />
      <p>
        L'hébergeur du site street_art est la société Wild code school, dont le
        siège social est situé au 17 rue Delandine 69002 Lyon, avec le numéro de
        téléphone : 09 78 45 04 38.
      </p>
      <br />
      <h2 className="h2_cgu">ARTICLE 2 : Accès au site</h2>
      <br />
      <p>
        Le site street_art permet à l'Utilisateur un accès gratuit aux services
        suivants : Le site internet propose les services suivants : Upload
        (chargement) de photos street art depuis un mobile/tablette ou
      ...
      <p>
        ...
        responsabilité de street_art. Dans ces cas, l’Utilisateur accepte ainsi
      ...
      <p>
        ...
        le site street_art ne peut être tenu responsable de la modification des
      ...
      <p>
        ...
        assume les risques liés à l'utilisation de son mail et mot de passe. Le
        site décline toute responsabilité.
      </p>
      <br />
      <p>
        Le site street_art ne peut être tenu pour responsable d’éventuels virus
      ...
      <p>
        ...
        est informé qu’en cliquant sur ces liens, il sortira du site street_art.
      ...
      <p>
        ...
        nécessaires à l’utilisation du site street_art.
      </p>
      <br />
      <p>
      ...
      <br />
      <p>
        L’utilisateur est sollicité pour la géolocalisation lors de l’upload de
        la photo. Celui-ci peut accepter ou refuser sans que cela perturbe la
        publication des photos sur le site (des coordonnées aléatoires seront
        alors générées par défaut au centre de Lyon).
      </p>
      <br />
      <h2 className="h2_cgu">ARTICLE 8 : Publication par l’Utilisateur</h2>
      <br />
      <p>
        Le site permet aux membres de publier les contenus suivants : Photos de
        street art.
      </p>
      <br />
      <p>
